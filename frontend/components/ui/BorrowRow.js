  ...
  return (
    <>
      <tr>
        ...
        <td className="border-t-0 px-4 bordear align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
        ...
        <td className="border-t-0 px-4 border  align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
            <div className="text-base">{todp(token.borrowAPYRate, 2)}%</div>
        </td>
        <td className="border-t-0 px-4 border  align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">

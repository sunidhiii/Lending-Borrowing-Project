        ...
        <table className="items-center w-full bg-transparent border-collapse">
          <thead>
            <tr>
              ...
              <th className="px-4 bg-blueGray-50 text-blueGray-500 align-right border border-solid border-blueGray-100 py-3 text-xs text-gray-800 border-t-0 border-l-0 border-r-0 whitespace-nowrap font-semibold text-left">
                Interest(stable)
              </th>
